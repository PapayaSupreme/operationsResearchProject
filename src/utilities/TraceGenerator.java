    ...
    public static void generateTrace(
        ...
        try {
           ...
           System.out.println("--- INITIALIZATION: " + method + " ---");
            ...
            GraphAlgo.ensureConnected(graph);  
            System.out.println(graph);
            
            Optional<Integer> initialCost = Tools.totalCost(graph);
            if (initialCost.isPresent()) {
                System.out.println("Initial total cost: " + initialCost.get());
            }
            System.out.println();
            ...
            while (iteration < maxIterations) {
                ...
                try {
                    ...
                    if (currentCost.isPresent()) {
                        System.out.println("Current total cost: " + currentCost.get());
                    }
